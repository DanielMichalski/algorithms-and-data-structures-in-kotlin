package pl.dmichalski.algorithms.data_structures._06_tree_traversal._2_depth_first_search._1_pre_order
...
object Runner {
    ...
    fun main(args: Array<String>) {
        ...
        println("------------------ DFS PreOrder traversal ------------------ ")
        val depthFistSearchTreeValues = binarySearchTree.depthFistSearchPreOrder()
