package com.danielmichalski.algorithms.data_structures._06_tree_traversal._2_depth_first_search._3_in_order
...
object Runner {
    ...
    fun main(args: Array<String>) {
        ...
        println("------------------ DFS InOrder traversal ------------------ ")
        val depthFistSearchTreeValues = binarySearchTree.depthFistSearchInOrder()
